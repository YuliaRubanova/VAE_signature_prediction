...
def two_step_vae_predict(rec_params, gen_params, data):
	...
	sample_second_tp = second_tp_means[:,126:252]
...
if __name__ == '__main__':
	...
	sample_second_tp, z_first_tp_means = two_step_vae_predict(optimized_params_first_tp, gen_layer_optimized, train_first_tp) 
